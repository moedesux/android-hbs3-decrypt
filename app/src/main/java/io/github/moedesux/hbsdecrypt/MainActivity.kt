...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) { super.onCreate(savedInstanceState); setContent { HbsDecryptApp(state, password, { sourcePicker.launch(arrayOf("*/*")) }, { destinationPicker.launch(null) }, { password = it; state = state.copy(passwordPresent = it.isNotEmpty()) }, ::start, ::cancel) } }
